...
const Navbar = ({ isSignedIn, username, handleLogout, setPrevLocation }) => {
  ...
  return (
    <div className="navbar-container drop-shadow-xl">
      {showNotification && (
        <div className=" text-ivory bg-burgundy bg-opacity-75 text-sm font-bhadra p-3 rounded-md shadow-md absolute top-13 mt-2 right-5 z-50">
          <div className="flex justify-between items-center">
            <span>Successfully logged in.</span>
            <button
              className="text-ivory font-bold ml-4"
              ...
              <li>
                <div className="relative">
                  {!isSignedIn ? (
                    <Link to="/signin">
                      <button
                        className="max-sm:ms-2 max-sm:mt-2 text-sm font-bhadra text-ivory bg-burgundy rounded-md hover:border-2 hover:border-burgundy hover:text-burgundy hover:bg-ivory w-16 h-7 mb-5 duration-150"
